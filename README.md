...
All four strategies share utility functions from `utils/image_utils.py`.
...
│   └── …
│
├── plots/                                # auto-saved output figures
│
├── strategies/                           # all 21 strategy modules
│   ├── strategy_random.py
│   ├── strategy_rowwise.py
...
│   ├── grid_utils.py                     # grid primitives (all strategies)
│   └── image_utils.py                    # image loading, metric, noise, normalisation
│
├── tests/                                # test suite
│   └── test_strategies.py
│
...
1. Create `strategies/strategy_image_mymetric.py`.
